...
class ClassroomController {
  ...
  async isLocked(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async fetchTeacherClassrooms(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
      if (!id) {
  ...
  async teacherClasroomLogout(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async fetchStudentsClassrooms(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
      if (!id) {
  ...
  async fetchClassroom(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
      if (!id) {
  ...
  async teacherJoinToClassroom(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async classroomData(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
      const classroomData = await ClassroomService.fetchClassroom(id);
      res.status(200).json(classroomData);
  ...
  async addClassroom(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async studentJoinToClassroom(req: Request, res: Response, next: NextFunction) {
    try {
      const { classroomid, studentid } = req.body;
  ...
  // Fetch classrooms for a specific teacher
  async classroomLogout(req: Request, res: Response, next: NextFunction) {
    try {
